...
public interface AnswerMapper {
    ...
    int updateAnswerByUserIdAndQuestionId(@Param("content") String content, @Param("userId") Integer userId, @Param("questionId") Integer questionId);

    String queryAnswerByUserIdAndQuestionId(@Param("userId") Integer userId, @Param("questionId") Integer questionId);
}